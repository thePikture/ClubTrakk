...
export default function WarnlnList() {
    ...
    return (
        <Page title="User">
            <Container>
                ...
                <Card>
                    <Box sx={{ margin: "15px 0px 0px 15px" }}>
                        <Typography variant="h5">
                            List of Warn-In Requested
                        </Typography>
                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            <Grid item xs={6} sx={12}>
                                <FormControl fullWidth size='small' sx={{ marginTop: "12px" }}>
