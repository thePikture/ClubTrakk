...
const TABLE_HEAD = [
    ...
    { id: 'classification', label: 'Classification', alignRight: false },
...
export default function CircularRules() {
    ...
    const newEvent = () => {
        navigate("/dashboard/new-circular-rules")
    }
